...
function FPP.AdminMenu(Panel)
	...
	addsldr(10, {"FPP_ANTISPAM", "bigpropwait"}, "Time (seconds) between spawning two big props", antispam)
	addsldr(10, {"FPP_ANTISPAM", "smallpropdowngradecount"}, "Spawn delay (in fraction) to consider spam", antispam)
	addsldr(10, {"FPP_ANTISPAM", "smallpropghostlimit"}, "How many props to spam before ghosting", antispam)
