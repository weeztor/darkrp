...
hook.Add("PhysgunPickup", "FAdmin_PickUpPlayers", function(ply, ent)
	...
	print(tobool(GetConVarNumber("FAdmin_AdminsCanPickUpPlayers")), FAdmin.Access.PlayerHasPrivilege(ply, "PickUpPlayers", ent))
	if tobool(GetConVarNumber("FAdmin_PlayersCanPickUpPlayers")) or (tobool(GetConVarNumber("FAdmin_AdminsCanPickUpPlayers")) and FAdmin.Access.PlayerHasPrivilege(ply, "PickUpPlayers", ent)) then
