...
function FAdmin.Access.PlayerHasPrivilege(ply, priv)
	if ply:EntIndex() == 0 or SinglePlayer() /*or ply:GetNWString("usergroup") == "root_user" */or (ply.IsListenServerHost and ply:IsListenServerHost()) then return true end -- This is the server console
