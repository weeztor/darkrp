...
hook.Add("FAdmin_PluginsLoaded", "ChangeLevel", function()
	...
	FAdmin.ScoreBoard.Server:AddServerAction("Changelevel", "maps/gm_construct", Color(155, 0, 0, 255), function() return FAdmin.Access.PlayerHasPrivilege(LocalPlayer(), "changelevel") end,
	function(ply, button)
